...
enum BUTTON_NAME { ADD, SHOW, LEFT, RIGHT, BACK, SAVE,CLOSE,FIND,TICKET_LEFT_BUTTON,ALL,OUT_OF_TICKET_BUTTON,FEMALE,MALE };
...
PLANE_NOT_EXIST,DAY_ERROR, MONTH_ERROR,TIME_ERROR,YEAR_ERROR, MINUTE_ERROR,HOUR_ERROR,GREATER_SEAT,ID_PASS_ERROR,GENDER_ERROR
};
