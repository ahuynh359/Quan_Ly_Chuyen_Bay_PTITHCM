...
enum BUTTON_NAME { ADD, SHOW, LEFT, RIGHT, BACK, SAVE,CLOSE,FIND,TICKET_LEFT_BUTTON,ALL,OUT_OF_TICKET_BUTTON,FEMALE,MALE,SEARCH };
enum MENU { MAIN_MENU, ADD_MENU, ADJUST_MENU, SHOW_MENU,FIND_PLANE_MENU,TICKET_MENU };
enum EDITTEXT_MESS { EMPTY, SEAT_ERROR, DUP, SUCCESS, PREVIOUS,CANCLE_FLIGHT_SUCCESS, 
	CANCLE_FLIGHT_ERROR,FLIGHT_IS_DONE,CANCLE_TICKET,
PLANE_NOT_EXIST,DAY_ERROR, MONTH_ERROR,TIME_ERROR,YEAR_ERROR, MINUTE_ERROR,HOUR_ERROR,GREATER_SEAT,ID_PASS_ERROR,GENDER_ERROR,DUP_ID_PASS,FULL_PLANE,
REMOVE_CONFIRM, REMOVE_ERROR, ADJUST_ERROR
};
